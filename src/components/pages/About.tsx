      ...
      <div className={styles.doc}>
        <div className={styles.doc_text_block}>
          ...
          <p>
            ...
            我的脑子总是记不住繁多的作业TT，网络学堂设计的不合理以及经常挂掉，使我有了兴趣来做这个网络学堂改造器。
          </p>
          <p>
            联系我们：
            <br />
            <a href="mailto:xxr3376@gmail.com">xxr3376@gmail.com</a>：初始开发者
            <br />
            <a href="mailto:harry-chen@outlook.com">harry-chen@outlook.com</a>：当前维护者
            <br />
          </p>
          <p>
            本插件以含附加条款的 MIT 协议在{' '}
            <a href="https://github.com/Harry-Chen/Learn-Helper">GitHub</a> 开放源代码。
          ...
          <p>
            ...
            致谢：
            <ul>
              <li> jiegec、CircuitCoder：为 4.0 的诞生做出了巨大的贡献 </li>
              <li> yaoht、moreD 等贡献者：对 2015 版网络学堂修复和支持 </li>
