(function() {
  var changeToken, clearCache, db_get, forceReload, getTheme, guiInit, gui_clearList, gui_main_createNewLine, gui_switchPage, gui_updateCourseList, gui_updateNormalList, gui_updatePopupNumber, iced, loadData, setAllReaded, setState, __iced_k, __iced_k_noop,
    __slice = [].slice;
