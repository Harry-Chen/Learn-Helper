...
(function() {
  var clearCache, db_clearCache, db_fixOldMess, db_get, db_getList, db_getPassword, db_getUsername, db_saveToken, db_set, db_setAllReaded, db_setState, db_updateCourseList, db_updateList, errorEnum, errorHandler, evaluation, filterCourse, flashResult, iced, load, mergeList, net_digDetail, net_getCourseList, net_login, net_submitServer, net_vaildToken, parser, prepareCollectList, prepareNormalList, processCourseList, progressLoader, readAll, recalculate, state, traverseCourse, updateJudge, version_control, __iced_k, __iced_k_noop,
    __slice = [].slice;
  ...
  version_control = function(op, version) {
    ...
    if (op === 'set') {
      return localStorage.setItem('learn_version_flag', version);
    }
  };
