...
(function() {
  var clearCache, db_get, forceReload, getTheme, guiInit, gui_clearList, gui_main_createNewLine, gui_switchPage, gui_updateCourseList, gui_updateNormalList, gui_updatePopupNumber, iced, loadData, setAllReaded, setState, __iced_k, __iced_k_noop,
    __slice = [].slice;
  ...
  guiInit = function() {
    ...
    return $('#option-force-reload-all').click(forceReload);
  };
  ...
  $(function() {
    ...
    return chrome.extension.onMessage.addListener(function(request, sender, sendResponse) {
      if (request.type === 'netError') return $('#net-error-modal').modal('show');
    });
  });
