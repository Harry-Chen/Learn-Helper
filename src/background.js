...
(function() {
  var db_clearCache, db_fixOldMess, db_get, db_getList, db_getPassword, db_getUsername, db_saveToken, db_set, db_setAllReaded, db_setState, db_updateCourseList, db_updateList, errorEnum, errorHandler, evaluation, filterCourse, flashResult, iced, load, mergeList, net_getCourseList, net_login, net_submitServer, parser, prepareCollectList, prepareNormalList, processCourseList, progressLoader, state, traverseCourse, version_control, __iced_k, __iced_k_noop,
    __slice = [].slice;
