...
(function() {
  ...
  prepareCollectList = (function() {
    ...
    return function(instruction, data) {
      var TC, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      if (instruction === 'setter') {
        ...
        (function(__iced_k) {
          if (instruction === 'backcall') {
            return __iced_k(backcallFunction = data);
          } else {
            (function(__iced_k) {
              if (instruction === 'update' && listCount === CONST.featureName.length) {
                ...
                (function(__iced_k) {
                  ...
                  db_set('cache_collect', cList, __iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                  ...
                  return __iced_k(backcallFunction && backcallFunction());
                });
              } else {
                return __iced_k();
              }
  ...
  load = function(sendResponse) {
    var bc, readyCounter, type, _i, _len, _ref;
    readyCounter = 0;
    bc = function() {
      readyCounter++;
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      type = _ref[_i];
      traverseCourse(type, prepareNormalList, function(p) {
        console.log(p);
